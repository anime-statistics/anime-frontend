// Generated from primeicons.css; the tag picker offers the whole icon set.
export const TAG_ICONS: readonly string[] = [
  'pi-address-book',
  'pi-align-center',
  'pi-align-justify',
  'pi-align-left',
  ...
  'pi-arrow-u-turn-up-left',
  'pi-arrow-u-turn-up-right',
  'pi-arrow-up',
  'pi-arrow-up-left',
  'pi-arrow-up-right',
